...
//        setTitle(team == null ? sessionId : team.getName() + "(" + team.getMemberCount()+")");
        setTitle("");
        String text=team == null ? sessionId : "<strong>"+team.getName()+"</strong><font color='#3c5fc5'>("+team.getMemberCount()+")</font>";
        ((TextView)findViewById(R.id.toolbar_title)).setText(Html.fromHtml(text));
