package com.pointhouse.chiguan.common.updatecommon;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    public void switchScrollLoadEnabled(boolean scrollLoadEnabled) {
        super.setScrollLoadEnabled(scrollLoadEnabled);
        ...
        if (scrollLoadEnabled) {
            ...
            if (null == mLoadMoreFooterLayout) {
                ...
                mLoadMoreFooterLayout.show(true);
                onRefreshComplete();
            } else if (mLoadMoreFooterLayout.getState() == ILoadingLayout.State.NO_MORE_DATA) {
                mLoadMoreFooterLayout.setState(ILoadingLayout.State.RESET);
                LoadingLayout loadingLayout = super.getFooterLoadingLayout();
            ...
            if (null != mLoadMoreFooterLayout) {
                if (mLoadMoreFooterLayout.getState() == ILoadingLayout.State.NO_MORE_DATA) {
                    onRefreshComplete();
                }
