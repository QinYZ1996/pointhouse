...
//		llPanel.setBackgroundColor(0xfff2f2f2);
        llPanel.setBackgroundColor(0xffffffff); // 去掉网格线
        /* --------------结束-------------- */
        ...
        for (int i = 0; i < lineCount; i++) {
            ...
            /* --------------开始-------------- */
            lp.leftMargin = DensityUtil.dip2px(llPanel.getContext(), 15);
            lp.rightMargin = DensityUtil.dip2px(llPanel.getContext(), 15);
            /* --------------结束-------------- */
...
//            lp.topMargin = paddingTop;
            ...
            lp = new LinearLayout.LayoutParams(DensityUtil.dip2px(ivLogo.getContext(), 51), DensityUtil.dip2px(ivLogo.getContext(), 51));
            lp.topMargin = paddingTop;
