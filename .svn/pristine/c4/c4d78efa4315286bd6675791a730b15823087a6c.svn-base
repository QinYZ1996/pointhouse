...
//        activity.getWindow().setBackgroundDrawable(new ColorDrawable(0x4c000000));
        ...
        colorDrawable.mutate().setAlpha(163);
		...
		/* --------------增加分享到layout开始-------------- */
        View view = View.inflate(getContext(), R.layout.share_description, null);
		...
		/* --------------增加取消按钮layout开始-------------- */
        view = View.inflate(getContext(), R.layout.share_cancel, null);
