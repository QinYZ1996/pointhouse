...
public class PermissionActivityBase extends Activity implements EasyPermissions.PermissionCallbacks {
        ...
        switch (requestCode) {
            case 1:
                if (permissionState == 0) {
                    if (!"true".equals(status)) {
                        Toast.makeText(this, "已获取日历权限", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(this, "已拒绝日历权限", Toast.LENGTH_SHORT).show();
                    SharedPreferencesUtil.saveSimple(
                            this,
                            sharePrefKey,
                            String.valueOf(requestCode),
            ...
            case 2:
                if (permissionState == 0) {
                    ...
                    Toast.makeText(this, "已拒绝拍照权限", Toast.LENGTH_SHORT).show();
                    SharedPreferencesUtil.saveSimple(
                            this,
                            sharePrefKey,
                            String.valueOf(requestCode),
            ...
            case 3:
                if (permissionState == 0) {
                    if (!"true".equals(status)) {
                        Toast.makeText(this, "已获取通讯录权限", Toast.LENGTH_SHORT).show();
                        SharedPreferencesUtil.saveSimple(
                                this,
                                sharePrefKey,
                                String.valueOf(requestCode),
                    ...
                    Toast.makeText(this, "已拒绝通讯录权限", Toast.LENGTH_SHORT).show();
                    SharedPreferencesUtil.saveSimple(
                            this,
                            sharePrefKey,
                            String.valueOf(requestCode),
            ...
            case 4:
                if (permissionState == 0) {
                    if (!"true".equals(status)) {
                        Toast.makeText(this, "已获取地理位置权限", Toast.LENGTH_SHORT).show();
                        SharedPreferencesUtil.saveSimple(
                                this,
                                sharePrefKey,
                                String.valueOf(requestCode),
                    ...
                    Toast.makeText(this, "已拒绝地理位置权限", Toast.LENGTH_SHORT).show();
                    SharedPreferencesUtil.saveSimple(
                            this,
                            sharePrefKey,
                            String.valueOf(requestCode),
            ...
            case 5:
                if (permissionState == 0) {
                    if (!"true".equals(status)) {
                        Toast.makeText(this, "已获取麦克风权限", Toast.LENGTH_SHORT).show();
                        SharedPreferencesUtil.saveSimple(
                                this,
                                sharePrefKey,
                                String.valueOf(requestCode),
                    ...
                    Toast.makeText(this, "已拒绝麦克风权限", Toast.LENGTH_SHORT).show();
                    SharedPreferencesUtil.saveSimple(
                            this,
                            sharePrefKey,
                            String.valueOf(requestCode),
            ...
            case 6:
                if (permissionState == 0) {
                    if (!"true".equals(status)) {
                        Toast.makeText(this, "已获取电话权限", Toast.LENGTH_SHORT).show();
                        SharedPreferencesUtil.saveSimple(
                                this,
                                sharePrefKey,
                                String.valueOf(requestCode),
                    ...
                    Toast.makeText(this, "已拒绝电话权限", Toast.LENGTH_SHORT).show();
                    SharedPreferencesUtil.saveSimple(
                            this,
                            sharePrefKey,
                            String.valueOf(requestCode),
            ...
            case 7:
                if (permissionState == 0) {
                    if (!"true".equals(status)) {
                        Toast.makeText(this, "已获取传感器权限", Toast.LENGTH_SHORT).show();
                        SharedPreferencesUtil.saveSimple(
                                this,
                                sharePrefKey,
                                String.valueOf(requestCode),
                    ...
                    Toast.makeText(this, "已拒绝传感器权限", Toast.LENGTH_SHORT).show();
                    SharedPreferencesUtil.saveSimple(
                            this,
                            sharePrefKey,
                            String.valueOf(requestCode),
            ...
            case 8:
                if (permissionState == 0) {
                    ...
                    Toast.makeText(this, "已拒绝短信权限", Toast.LENGTH_SHORT).show();
                    SharedPreferencesUtil.saveSimple(
                            this,
                            sharePrefKey,
                            String.valueOf(requestCode),
            ...
            case 9:
                if (permissionState == 0) {
                    if (!"true".equals(status)) {
                        Toast.makeText(this, "已获取存储空间权限", Toast.LENGTH_SHORT).show();
                        SharedPreferencesUtil.saveSimple(
                                this,
                                sharePrefKey,
                                String.valueOf(requestCode),
                    ...
                    Toast.makeText(this, "已拒绝存储空间权限", Toast.LENGTH_SHORT).show();
                    SharedPreferencesUtil.saveSimple(
                            this,
                            sharePrefKey,
                            String.valueOf(requestCode),
