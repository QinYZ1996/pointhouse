...
import com.pointhouse.chiguan.common.jsonObject.TestLessonDetailJson;
...
public class CourseAuditionActivity extends MediaBaseActivity {
    ...
    private View viewContent, line, whiteBackView, titleBar, back, textOnlyLayout;
    ...
    private void initView(int lessonId, CommonMediaOption optionFromParam) {
        ...
        textOnlyLayout = findViewById(R.id.viewTextOnly);
        ...
        scrollView = (MyScrollView) findViewById(R.id.viewScroll);
...
//                            LessonDetailGetBean lessonDetail = new LessonDetailGetBean(TestLessonDetailJson.NormalJson);
