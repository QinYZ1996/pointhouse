...
public class TeamMemberAdapter extends TAdapter {
    ...
    public TeamMemberAdapter(Context context, List<?> items, TAdapterDelegate delegate,
                             RemoveMemberCallback removeMemberCallback, AddMemberCallback addMemberCallback,boolean showName) {
        super(context, items, delegate);
        this.context = context;
        this.removeMemberCallback = removeMemberCallback;
        this.addMemberCallback = addMemberCallback;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(((TeamMemberHolder) view.getTag()).showName!=showName){
            ((TeamMemberHolder) view.getTag()).showName=showName;
            ((TeamMemberHolder) view.getTag()).refreshName();
        }
